  ...
  return (
    <div className="w-full md:w-1/3 pl-4 space-y-6">
      <div className="mb-6 p-4 bg-gradient-to-r from-red-500 to-pink-500 rounded-lg shadow-lg text-white">
        ...
        <p>Have an event you would like to share? Post it on Goeventi for free! Create an account, fill out a simple form, and you are all set.</p>
      ...
      <div className="p-4 bg-white rounded-lg shadow-lg">
        ...
        <ul className="list-disc pl-5 text-gray-600">
          ...
          <li className="mb-2">Ads - Exclusive deals and offers you cannot miss.</li>
